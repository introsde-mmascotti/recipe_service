...
/**
 * <p>Java-Klasse für storeRecipeResponse complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="storeRecipeResponse">
 *   &lt;complexContent>
...
@XmlType(name = "storeRecipeResponse", propOrder = {
    "_return"
})
public class StoreRecipeResponse {
